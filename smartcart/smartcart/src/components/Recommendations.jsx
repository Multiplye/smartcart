  ...
  return (
    <main className="page-wrapper">
      {/* ==========================================
          HEADER
          ==========================================
          A single centred column. The width is capped and the block is
          centred rather than left-aligned, so the copy reads as an
          intentional block instead of text stranded in the corner of a
          wide page.

          There used to be an "Engine status" panel on the right to fill
          that space. It reported Personalised / Source / Method, which
          was interesting but read like a debug readout sitting in the
          middle of a shop - so it is gone. The page already says where
          the list came from in the sentence below the title. */}
      <section className="rec-header ai-rise">
        <span className="rec-header-label">SMART RECOMMENDATIONS</span>
        ...
        <div className="rec-header-actions">
          ...
          {!isPersonal && (
            ...
            <Link
              to="/#auth"
              className="rec-header-link rec-header-link-quiet"
            >
